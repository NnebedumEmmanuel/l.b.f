...
const ScheduleSection = () => {
  return (
    <div
      class="shedule padding--top padding--bottom bg-img"
        ...
        <div class="row g-4">
          <div class="col-xl-4 col-12">
            <div class="section__header mb-xl-0 text-white">
              ...
              <p class="mb-0">
                Holisticly extend sticky partnerships and cross functional
                markets. Monotonectally.
              </p>
            </div>
          </div>
                      ...
                      <div class="shedule__right">
                        <div class="shedule__time">
                          <ul
                            ...
                            data-date="Nove 14, 2022 21:14:01"
                          >
                            <li class="clock-item">
                    ...
                    <div class="shedule__content">
                      ...
                      <div class="shedule__right">
                        <div class="shedule__time">
                          <ul
                            class="countdown count-down"
                            data-date="Nove 13, 2022 21:14:01"
                          >
                            <li class="clock-item">
                              <span class="count-number days">56</span>
                              <p class="count-text">Days</p>
                    ...
                    <div class="shedule__content">
                      ...
                      <div class="shedule__right">
                        <div class="shedule__time">
                          <ul
                            class="countdown count-down"
                            data-date="Nove 12, 2022 21:14:01"
                          >
                            <li class="clock-item">
                              <span class="count-number days">56</span>
                              <p class="count-text">Days</p>
                    ...
                    <div class="shedule__content">
                      ...
                      <div class="shedule__right">
                        <div class="shedule__time">
                          <ul
                            class="countdown count-down"
                            data-date="Nove 11, 2022 21:14:01"
                          >
                            <li class="clock-item">
                              <span class="count-number days">56</span>
                              <p class="count-text">Days</p>
                    ...
                    <div class="shedule__content">
                      ...
                      <div class="shedule__right">
                        <div class="shedule__time">
                          <ul
                            class="countdown count-down"
                            data-date="Nove 10, 2022 21:14:01"
                          >
                            <li class="clock-item">
                              <span class="count-number days">56</span>
                              <p class="count-text">Days</p>
